...
public final class RayTraceUtils {
    ...
    // altoclef fork addition: tasks that dig out liquids need the raytrace to see fluids,
    // so this is toggled around by BotBehaviour instead of being hardcoded to NONE.
