...
//                            && mod.getPlayer().getDeltaMovement().getX() == 0 && mod.getPlayer().getDeltaMovement().getY() == 0 && mod.getPlayer().getDeltaMovement().getZ() == 0
                    ) {
                    ...
                    if (!bedPlaced) {
                        ...
                        //Optional<Rotation> placeReach = LookHelper.getReach(bedTargetPosition.below(), Direction.UP);
                        if (canPlace) {
                            // Look at and place!
                            if (mod.getSlotHandler().forceEquipItem(ItemHelper.BED, true)) {
                                ...
                                //if (mod.getClientBaritone().getPlayerContext().isLookingAt(bedTargetPosition.below())) {
