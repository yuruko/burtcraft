...
public class BeeMovieTask extends Task {
    ...
    protected Task onTick(AltoClef mod) {
        ...
        while (true) {
            ...
            // Fortify below
            //BlockState below = Minecraft.getInstance().world.getBlockState(currentSignPos.below());
            boolean canPlace = WorldHelper.isSolid(mod, currentSignPos.below());//isSideSolidFullSquare(Minecraft.getInstance().level, currentSignPos.below(), Direction.MAX_Y);
            if (loaded && !canPlace) {
