...
public class Settings implements IFailableConfigFile {
     ...
     * task chain.
     */
    // burnt fork: default OFF - the task-chain readout is debug chrome and must
    // never sit on top of her stream. a regenerated settings file (fresh game
    // dir) used to bring it back; now the default keeps it hidden.
    private boolean showTaskChains = false;
