...
//        Minecraft.getInstance().
        ...
        if (screen instanceof DeathScreen) {
            ...
            if (screen instanceof DisconnectedScreen) {
                ...
                if (_prevServerEntry == null) {
                    ...
                    //ConnectScreen.connect(screen, client, ServerAddress.parseString(_prevServerEntry.ip), _prevServerEntry);
    ...
    public boolean runsWhileIdle() {
        ...
        // death screen until host-side happened to send an unrelated command.
        return true;
    }
